...
class AquaCrop(Model):
    ...
    def initial(self):
        ...
        self.root_zone_water_module = AQRootZoneWater(self)
        ...
        self.growth_stage_module = AQGrowthStage(self)
        self.root_development_module = AQRootDevelopment(self)
        ...
        self.evapotranspiration_module = AQEvapotranspiration(self)
    ...
    def dynamic(self):
        ...
        # print self._modelTime.timeStepPCR
